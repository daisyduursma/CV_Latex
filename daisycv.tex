...
\cventry{Nationality}{United States of America}{}{}{}{}
...
\cventry
  ...
  \item Create and implement interactive tools to effectively communicate large amounts of data in ways that are useable to the stakeholders.
  \item Liaise with key stakeholders to optimize project’s outputs to and ensure these are most beneficial to the client.
  \item Develop, organise and teach spatial data analysis and visualization (R and ArcGIS).
  \item Utilize high performance computing (HPC) to transform datasets to uniform formatting to increase data access, usability and discoverability.
...
\cventry
  ...
  {}
  {\begin{itemize}
  \item Integration of forest growth data in sawmill ...using R and ArcGIS to visualize and summarize habitat quality. 
  \item Wrote project proposals and reports for funding agencies and governmental agencies.
  \item Participant in EU wide project to harmonize forest carbon storate reporting methods. 
  \end{itemize}
  }
...
\cvitem{Programming - excellent}{R (Spatial analyses, large datasets, maps, etc.)}{}{}
\cvitem{Programming - good}{Python, Unix}{}{}
\cvitem{ArcGIS}{ArcMap, ArcInfo}{}{}
\cvitem{MS Office}{Word, Excel, Powerpoint}{}{}
